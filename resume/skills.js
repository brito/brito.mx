    ...
    Experience = [
        {
            ...
            from: '2002-12',
            to: '2007-03',
            skills: 'JS/ES6 jQuery UX CSS3 HTML5 Recruiting Regex REST/JSON Git/SVN Java/J2EE Portal BPM XML a11y/WCAG2 i18n/l16n'
        },{
            at: 'Google',
            from: '2007-03',
            to: '2009-09',
            skills: 'CSS3 HTML5 JS/ES6 UX bash C++ P4 UX latency Python Recruiting'
        },{
            at: 'Gravity',
            from: '2009-11',
            to: '2011-02',
            skills: 'JS/ES6 jQuery CSS3 HTML5 PHP UX Git/SVN dataviz REST/JSON'
        },{
            at: 'Small Demons',
            from: '2011-10',
            to: '2012-11',
            skills: 'jQuery CSS3 HTML5 UX JS/ES6 Hg Python Typography'
        },{
            at: 'Intertrust',
            from: '2012-12',
            to: '2013-04',
            skills: 'JS/ES6 CSS3 HTML5 UX Git/SVN BackboneJS'
        },{
            at: 'Oracle',
            from: '2013-04',
            to: '2017-07',
            skills: 'UX Sales MADP/MBaaS Typography HTML5 CSS3 JS/ES6 Java/J2EE Git/SVN SVG bash Nodejs FCPX Portal dataviz a11y/WCAG2 Cordova SaaS/PaaS BPM'
        }
    ]
    //
    .map(work => {
